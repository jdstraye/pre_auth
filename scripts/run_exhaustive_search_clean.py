...
def run_search(args):
    ...
    # Use provided train/test CSVs if present (e.g., produced by src/allocate.py --strategy bin_high_ks)
    if args.train_csv and args.test_csv:
        ...
        X_train_full = df_tr[feature_cols].copy()
...
def main():
    ...
    parser.add_argument('--train-csv', type=Path, default=None, help='Optional precomputed train CSV to use')
    parser.add_argument('--test-csv', type=Path, default=None, help='Optional precomputed test CSV to use')
